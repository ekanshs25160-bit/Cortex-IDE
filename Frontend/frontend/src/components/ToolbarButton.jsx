...
export default function ToolbarButton({ icon, title, onClick }) {
  return (
    <button 
      onClick={onClick} 
      className="p-1.5 rounded text-on-surface-variant hover:text-primary-fixed-dim hover:bg-white/5 transition-all group relative" 
      title={title}
    >
      {icon}
