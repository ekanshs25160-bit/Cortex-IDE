...
Memori uses the native **fastembed** backend with the default **all-MiniLM-L6-v2** embedding model and cosine similarity for semantic search. You can tune recall behavior with these configuration options:
