...
In this example, we will use Memori with OpenAI and SQLite. Check out the [LLM providers & frameworks](/docs/memori-byodb/llm/overview) and [database](/docs/memori-byodb/databases/overview) guides for other integrations.
