---
name: memori-memory
description: Use when working with Memori agent-native memory in Hermes for targeted recall, summaries, signup, feedback, and trace-backed continuity across sessions.
version: 0.1.0
author: Memori Labs
license: MIT
metadata:
...
- Do not call signup or feedback tools unless the user's request or a Memori error makes them relevant.
