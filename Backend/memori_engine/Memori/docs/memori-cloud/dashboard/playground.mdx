...
![Playground overview with conversation, memory usage, extracted memories, and memory graph](https://images.memorilabs.ai/docs/playground-memory-graph-expanded.webp)
...
![Memory graph card in Playground](https://images.memorilabs.ai/docs/playground-overview.webp)
...
![Extracted memories panel with Clean action](https://images.memorilabs.ai/docs/playground-extracted-memories.webp)
