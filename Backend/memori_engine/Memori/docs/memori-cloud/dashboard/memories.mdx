...
- **Summary**: The memory text captured from conversations and agent trace
...
![Memories table view with semantic search and table or knowledge graph switcher](https://images.memorilabs.ai/docs/memories-overview-table.webp)
...
![Subjects table view with all types filter and subject memory counts](https://images.memorilabs.ai/docs/memories-detail-drawer.webp)
...
![Memory details drawer showing details fields and associated subjects graph](https://images.memorilabs.ai/docs/memories-subjects-table.webp)
...
![Entities knowledge graph view with search and time filter](https://images.memorilabs.ai/docs/entities-knowledge-graph.webp)
